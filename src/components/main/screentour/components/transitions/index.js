...
function Transitions(props) {
    ...
    return (
        <div className='container'>
            ...
            <br></br>
                <div className='pictureContainer'>
                    <img className='picture' src={dissolveToExample}  alt='dissolve to example' />
                    <div className='pictureLabel'><span id='courrier'>VS.</span></div>
                    <img className='picture' src={quickCutToExample}  alt='quick cut to example' />
                </div>
            <br></br>
                    ...
                    {handleShow &&
                        <div className='screengradeBlogText'>
                            <div className='screengradePictureContainer'>
                                <img className='picture' src={screengradeIntercutSlugs}  alt='screengrade version of intercut slugs' />
                            </div>
