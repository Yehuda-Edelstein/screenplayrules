    ...
    return (
        <div className='container'>
            <div className='containerHeader'>
                <Link to='/screentour/fadein'  style={{color: 'inherit', textDecoration: 'inherit'}}><span className='startLink'>
                    <FontAwesomeIcon icon={faArrowLeft}/></span>
                </Link>
                <span>SLUGS</span>
                <Link to='/screentour/action'  style={{color: 'inherit', textDecoration: 'inherit'}}><span className='startLink'>
            ...
            <div className='blog'> 
                ...
                <br></br>
                <br></br>    
                    That being said, it's a bit of an amateur move to have your locations be overly descriptive. Personally, seeing a slugline that's longer than the description beneath it is alarming. "<span id='courrier'>DUMPSTER BEHIND BURGER JOINT</span>" should just be "<span id='courrier'>BURGER      JOINT</span>". Leave your details in the description. 
                    <div className='sluglineExamplePart'>
                ...
                <br></br>
                <br></br>
                    At last we have the when of your slugline -- the time your scene takes place at. Although this seems simple enough, don't make the mistake of having your times be too nuanced. 
                <br></br>
                <br></br>
                    ...
                    If you want a more specific time than one of these listed, you'll need to superimpose<sup>3</sup> it.
                <br></br>
                <br></br>
