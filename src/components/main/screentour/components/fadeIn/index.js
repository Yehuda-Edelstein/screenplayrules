      ...
      <div className="container">
        ...
        <div className="blog">
          <div className="blogText">
            ...
            we, the audience, will see. Simply put, every line of script that
            goes beneath them will be acted, spoken, filmed, and produced, up
            until the last words "<span id="courrier">FADE OUT</span>" which
            we'll get to later.
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>"<span id="courrier">FADE IN</span>" is unnecessary and
            totally antiquated.
            <br></br>
            <br></br>
            It's a staple of the craft, so keeping it won't bring down your
            screengrade<sup>1</sup> too much, but it's ridiculous. It didn't
            even make sense when cameras could <span id="italic">only</span>{" "}
            fade in -- obviously the first line on page 1 is where the script
            starts, and the last line on 110<sup>2</sup> is where it ends.
            <br></br>
            <br></br>
            Plus, I think slugs<sup>3</sup> look best as the first words on a
            page regardless, but more on that in the next section. Either way, I
            think it's time we let the fades become a thing of the past.
            <br></br>
            <br></br>
            Here's a comparison:
