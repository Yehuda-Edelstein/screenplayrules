        ...
        <div className='container'>
            ...
            <div className='blogText'>
                ...
                <br></br>
                    ...
                    <br></br>
                            3. Long paragraphs are bad, just like long sentences are. Better to have three seperate <a href='glossary/blocks'>blocks</a> for a total of five lines (seven including <a href='glossary/whitelines'>white lines</a>) than one block for a total of five lines. If you don't know what blocks or white lines are check out the <a href='glossary'>glossary</a>. In any case, we had to break this bad boy up. 
                    <br></br>
                            4. The <span id='yellow'><span id='courrier'>S</span></span> and <span id='yellow'><span id='courrier'>B</span></span> are problatic because <a href='glossary/parallelcaps'>parallel capitalization</a> is offputting. Now, even though only the <span id='yellow'><span id='courrier'>B</span></span> is actually problomatic, I highlighted both letters to shed more light on the issue. Know that this applies whether they're at the start of the line, end of the line, or anywhere in between. You may think I'm nuts but I've done my research and readers do respond better to scripts that minamize <a href='glossary/parallelcaps'>stacked caps</a>. Worse than that, is doing it with the same capitalized letter. Worse even than that (see!) is with full words. Personally, I wouldn't even start succeeding paragraphs with the same word or letter either. But, hey, that's just me.
                    <br></br>
            ...
            <br></br>
                ...
                {handleShowSecond &&
                    ...
                    <br></br>
                    <img className='picture' src={withAgeAfterEdits}  alt='with age' width={'250px'}/>
                    </div>
                }   
